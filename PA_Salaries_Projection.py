...
PA_Salaries = pd.read_csv("C:\\Information_Science\\My_projects\\2013_Salaries__Pennsylvania_State_System_of_Higher_Education.csv")
print(PA_Salaries)
X = PA_Salaries.iloc[:, :-1].values

y = PA_Salaries.iloc[:, -1].values
print(X)
print(y)
...
plt.xlabel('College and Profession')
plt.ylabel('Salary')
...
print(result.to_csv("C:\\Information_Science\\My_Projects\\PA_Salaries_Projection"))
